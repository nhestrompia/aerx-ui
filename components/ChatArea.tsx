...
export const ChatArea: React.FC = () => {
  return (
    <SmoothCorners corners="32" borderRadius="28px">
                ...
                <div className="flex items-center">
                  ...
                  >
                    <ellipse
                      ...
                      rx="7.67417"
                      ry="13.9967"
                      transform="rotate(120 16.1332 14.5724)"
                      fill="#B882E1"
                    />
                    <ellipse
                      cx="16.1331"
                      ...
                      rx="7.67417"
                      ry="13.9967"
                      transform="rotate(60 16.1331 23.5763)"
                      fill="white"
                      fillOpacity="0.3"
                    />
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M9.15347 19.0734C10.1054 19.8376 11.1576 20.5599 12.2962 21.2172C18.9907 25.0823 26.1356 25.24 28.2548 21.5695C28.3086 21.4763 28.3587 21.3814 28.4051 21.285C28.6767 20.5228 28.8283 19.7794 28.8486 19.0731C28.8282 18.3671 28.6767 17.624 28.4052 16.8622C28.3588 16.7657 28.3087 16.6708 28.2548 16.5774C26.1356 12.9069 18.9907 13.0646 12.2962 16.9297C11.1576 17.587 10.1054 18.3093 9.15347 19.0734Z"
                      fill="#DCAFFF"
                    />
                  </svg>
                ...
                <ul className=" font-normal">
                  <li className="flex justify-start mt-28 mb-6">
                    <SmoothCorners corners="35">
                      <div className="relative max-w-xl px-5 py-5  bg-[#b882e1] text-white super-ellipse rounded-[20px] rounded-bl-[2px] shadow">
