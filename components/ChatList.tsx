    ...
    <SmoothCorners corners="32,42" borderRadius="20px">
      <div className="container squircle-base rounded-[20px] pb-[43px] relative z-10  before:bg-blue-600 pb- after:bg-red-600 bg-[#141414] h-full  lg:col-span-1 ">
        <div className="flex justify-around  items-start">
          <div className="">
            <h2 className="mt-7 text-[20px] tracking-[-0.02em] font-semibold text-white">
              Chats
            </h2>
          </div>
          <div className="flex flex-row gap-4 mt-6 items-baseline text-white">
            <h1
              ...
              } tracking-[-0.02em] relative -top-0.5 squircle cursor-pointer text-sm rounded-xl `}
            >
              Personal
            </h1>
            ...
            <h1
              ...
              }  text-sm squircle cursor-pointer relative -top-0.5 tracking-[-0.02em] `}
            >
              Work
            </h1>
          </div>
        ...
        <div className="ml-[30px]  mr-[22px] mt-3 bg-[#0F0F0F] rounded-xl ">
          <SmoothCorners corners="5">
            <div className="relative  right-1 mr-1">
              ...
              <input
                type="search"
                className="block w-full  rounded-[10px]  py-3 pl-12  bg-[#0f0f0f] text-white placeholder-[#575757] placeholder-opacity-80 text-base squircle-search  outline-none"
                name="search"
          ...
          <div className="bg-[#6054F0] absolute left-[283px] ml-[6px] top-36 rounded-full w-1 h-[100px]"></div>
        </div>
